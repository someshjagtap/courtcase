...
describe('CourtCase Management Component', () => {
  let comp: CourtCaseComponent;
  let fixture: ComponentFixture<CourtCaseComponent>;
  let service: CourtCaseService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'court-case', component: CourtCaseComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(CourtCaseComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.courtCases?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
