...
export class UserDataComponent implements OnInit {
  ...
  trackId(index: number, item: IUserData): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IUserData[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
