...
describe('Hearing Management Component', () => {
  let comp: HearingComponent;
  let fixture: ComponentFixture<HearingComponent>;
  let service: HearingService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'hearing', component: HearingComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(HearingComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.hearings?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
