...
public class CourtCase implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = { "cases" }, allowSetters = true)
    ...
    public void setUsers(Set<UserData> userData) {
        if (this.users != null) {
            this.users.forEach(i -> i.setCourtCase(null));
        }
        if (userData != null) {
            userData.forEach(i -> i.setCourtCase(this));
        }
        this.users = userData;
    }

    public CourtCase users(Set<UserData> userData) {
        this.setUsers(userData);
        return this;
    }

    public CourtCase addUser(UserData userData) {
        this.users.add(userData);
        userData.setCourtCase(this);
        return this;
    }

    public CourtCase removeUser(UserData userData) {
        this.users.remove(userData);
        userData.setCourtCase(null);
        return this;
    }
    ...
    public CourtCase hearing(Hearing hearing) {
